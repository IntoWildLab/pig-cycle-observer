...
- [Anspire Open](https://open.anspire.cn/)：支持模型和新闻搜索。
- [AIHubMix](https://aihubmix.com/)：支持在一个平台切换多种模型。
...
2. 用 AIHubMix：如需新闻搜索，可另行配置 [SerpAPI](https://serpapi.com/) 或 [Tavily](https://tavily.com/) 的 Key，填到 `SerpAPI API Keys` 或 `Tavily API Keys`。
