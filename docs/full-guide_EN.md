...
|------------|------|:----:|
| `ANSPIRE_API_KEYS` | [Anspire](https://open.anspire.cn/) API key for LLM access and Chinese-optimized web search | Optional |
| `AIHUBMIX_KEY` | [AIHubMix](https://aihubmix.com/) API key for multiple model families | Optional |
...
| `SERPAPI_API_KEYS` | [SerpAPI](https://serpapi.com/) search-engine results for realtime financial news | Optional |
